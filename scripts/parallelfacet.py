...
@author: norman
"""
#Plot parallel lines of  *0.25 - *4 of the standard species on top of the CO CO2 plots
...
if ice:
    plotspath = "../VaryFromSolar/"+papersize+xaslog+"FGPllPlots"+str(switch)
else:
    plotspath = "../VaryFromSolar/"+papersize+xaslog+"FGNoIcePllPlots"+str(switch)
