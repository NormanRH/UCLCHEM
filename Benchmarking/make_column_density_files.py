...
for cloud_type in ["low_rad","high_rad"]:
	...
	particle_df["delta_h2_col"]=particle_df["delta_x"].values*particle_df["X(H2)"].values*particle_df["n_H"].values
	...
	particle_df=particle_df.iloc[1:step*48+1:step] #only want 48 models
